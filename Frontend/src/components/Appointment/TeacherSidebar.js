...
const TeacherSidebar = (props) => {
    const { setShowAppointment, setShowSchedule } = props;
    ...
    return (
        <div>
            ...
            <div className='content'>
                <div
                    className={appointmentActive ? 'selection active' : 'selection'}
                ...
                <div
                    className={scheduleActive ? 'selection active' : 'selection'}
